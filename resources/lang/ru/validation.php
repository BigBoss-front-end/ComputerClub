...
return [
    ...
    'attributes' => [
        ...
        /*
    |--------------------------------------------------------------------------
    | Пользовательские языковые ресурсы для проверки значений
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете указать собственные сообщения для атрибутов, используя
    | соглашение "attribute.rule", чтобы назвать строки. Это позволяет
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие языковые строки используются для замены нашего атрибута
    | заполнителя чем-то более дружелюбным для читателя, например, вместо
    | "email" лучше использовать "электронный адрес". Это просто помогает
    | нам сделать наше сообщение более выразительным.
    |
    */
